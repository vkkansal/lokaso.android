...
public class LoginActivity extends ActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgotPass.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                forgotPassAld = new Dialog(LoginActivity.this);
                forgotPassAld.requestWindowFeature(Window.FEATURE_NO_TITLE);
                forgotPassAld.setContentView(R.layout.forget_pass);
                forgotPassAld.show();
    ...
    public void signin() {
        ...
        CustomRequest jsonReq = new CustomRequest(Request.Method.POST, METHOD_AUTH_SIGNIN_POST, null,
