...
public class ToyotaFragmentTab extends Fragment implements Constants {

    int offset = 0;
    int limit = 10;
    int pageNo = 0;
    int arrayLength = 0;
    private ArrayList<UserFriends> streamList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        streamList = new ArrayList<UserFriends>();
    ...
    public void getStream() {
        ...
        CustomRequest jsonReq = new CustomRequest(Request.Method.GET, METHOD_USERS_FOLKS_GET+1, null,
