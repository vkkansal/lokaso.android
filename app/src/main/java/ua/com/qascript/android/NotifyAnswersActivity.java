...
public class NotifyAnswersActivity extends ActivityBase implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoadingScreen = (RelativeLayout) findViewById(R.id.NotifyAnswersLoadingScreen);
        mErrorScreen = (RelativeLayout) findViewById(R.id.NotifyAnswersErrorScreen);

        mErrorScreenMsg = (TextView) findViewById(R.id.NotifyAnswersErrorScreenMsg);

        mContentScreen = (SwipeRefreshLayout) findViewById(R.id.NotifyAnswersContentScreen);
        mContentScreen.setOnRefreshListener(this);

        mListView = (ListView) findViewById(R.id.NotifyAnswersListView);
        ...
        adapter = new NotifyListAdapter(NotifyAnswersActivity.this, notifyList);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent intent = new Intent(NotifyAnswersActivity.this, AnswerActivity.class);
    ...
    public void getAnswersNotifications() {
